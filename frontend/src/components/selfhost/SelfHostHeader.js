...
const products = [
  // { name: 'Share File Without Storing', description: 'Send and receive end-to-end encrypted files.', href: '/quick-share', icon: "grid-fill" },
...
const ctaLink = "https://github.com/Mritunjay-Aditya"
